        ...
        <div className="bg-[#F7E6FE]">
            ...
            <div className="bg-cover bg-no-repeat bg-center py-36" style={{ backgroundImage: "url('/assets/images/banner-bg.jpeg')" }}>
                <div className="container">
                    ...
                    rounded-md font-swash">Compra Ahora</a>
                    </div>
                </div>
            </div>
            {/* ./banner */}
            ...
            <div className="container py-16">
                ...
                <div className="grid grid-cols-3 gap-3">
                    <div className="relative rounded-sm overflow-hidden group">
                        ...
                        <a href="#"
                            className="absolute inset-0 bg-black/30 hover:bg-black/60  flex items-center justify-center text-xl text-white font-medium group-hover:bg-opacity-60 transition font-surfer">Cuidado Facial</a>
                    </div>
                    <div className="relative rounded-sm overflow-hidden group">
                        <img src="/assets/images/category/category-2.jpg" alt="category 1" className="w-full h-full" />
                        <a href="#"
                            className="absolute inset-0 bg-black/30 hover:bg-black/60 flex items-center justify-center text-xl text-white font-surfer font-medium group-hover:bg-opacity-60 transition">Maquillaje</a>
                    </div>
                    <div className="relative rounded-sm overflow-hidden group">
                        <img src="/assets/images/category/category-3.jpg" alt="category 1" className="w-full h-full" />
                        <a href="#"
                            className="absolute inset-0 bg-black/30 hover:bg-black/60 flex items-center justify-center text-xl text-white font-surfer font-medium group-hover:bg-opacity-60 transition">Desmaquillantes
                        </a>
                    </div>
                    <div className="relative rounded-sm overflow-hidden group">
                        <img src="/assets/images/category/category-4.jpg" alt="category 1" className="w-full h-full" />
                        <a href="#"
                            className="absolute inset-0 bg-black/30 hover:bg-black/60 flex items-center justify-center text-xl text-white font-surfer font-medium group-hover:bg-opacity-60 transition">Tónicos</a>
                    </div>
                    <div className="relative rounded-sm overflow-hidden group">
                        <img src="/assets/images/category/category-5.jpg" alt="category 1" className="w-full h-full" />
                        <a href="#"
                            className="absolute inset-0 bg-black/30 hover:bg-black/60 flex items-center justify-center text-xl text-white font-surfer font-medium group-hover:bg-opacity-60 transition">Cuidado Capilar
                        </a>
                    </div>
                    <div className="relative rounded-sm overflow-hidden group">
                        <img src="/assets/images/category/category-6.jpg" alt="category 1" className="w-full h-full" />
                        <a href="#"
                            className="absolute inset-0 bg-black/30 hover:bg-black/60 flex items-center justify-center text-xl text-white font-surfer font-medium group-hover:bg-opacity-60 transition">Brochas</a>
                    </div>
                </div>
            </div>
            {/* ./categories */}
